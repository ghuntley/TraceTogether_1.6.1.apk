...
public final class V2Central implements CentralInterface {
    ...
    public final byte[] prepareWriteRequestData(int i, int i2, Integer num) {
        return new V2WriteRequestPayload(i, C3577lt.f2990.m3687(), BuildConfig.ORG, C3577lt.f2990.m3685(), i2).getPayload();
    }
    ...
    public final ConnectionRecord processReadRequestDataReceived(byte[] bArr, String str, int i, Integer num) {
        ...
        try {
            ...
            return new ConnectionRecord(fromPayload.getV(), fromPayload.getId(), fromPayload.getO(), new lZ(fromPayload.getMp(), str), C3577lt.f2990.m3685(), i, num);
        } catch (Throwable th) {
