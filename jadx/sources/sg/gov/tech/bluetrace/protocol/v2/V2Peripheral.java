...
public final class V2Peripheral implements PeripheralInterface {
    ...
    public final byte[] prepareReadRequestData(int i) {
        return new V2ReadRequestPayload(i, C3577lt.f2990.m3687(), BuildConfig.ORG, C3577lt.f2990.m3688()).getPayload();
    }
    ...
    public final ConnectionRecord processWriteRequestDataReceived(byte[] bArr, String str) {
        ...
        try {
            ...
            return new ConnectionRecord(fromPayload.getV(), fromPayload.getId(), fromPayload.getO(), C3577lt.f2990.m3688(), new C3588ma(fromPayload.getMc(), str), fromPayload.getRs(), (Integer) null);
        } catch (Throwable th) {
