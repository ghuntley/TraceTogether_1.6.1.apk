...
final class Hpack {
    static final Map<jM, Integer> NAME_TO_FIRST_INDEX = nameToFirstIndex();
    ...
    static final class Reader {
        ...
        Reader(int i, jY jYVar) {
            this(i, i, jYVar);
        }

        Reader(int i, int i2, jY jYVar) {
        ...
        /* access modifiers changed from: package-private */
        public final jM readByteString() {
            int readByte = readByte();
            boolean z = (readByte & 128) == 128;
            int readInt = readInt(readByte, Hpack.PREFIX_7_BITS);
            if (z) {
                return jM.m2947(Huffman.get().decode(this.source.m2916((long) readInt)));
            }
            return this.source.m2922((long) readInt);
        }
    }

    private static Map<jM, Integer> nameToFirstIndex() {
    ...
    static final class Writer {
        ...
        Writer(int i, boolean z, jH jHVar) {
        ...
        public final void writeHeaders(List<Header> list) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                jM r4 = header.name.m2955();
                jM jMVar = header.value;
                Integer num = Hpack.NAME_TO_FIRST_INDEX.get(r4);
                if (num != null) {
                    i2 = num.intValue() + 1;
                    if (i2 > 1 && i2 < 8) {
                        if (Util.equal(Hpack.STATIC_HEADER_TABLE[i2 - 1].value, jMVar)) {
                            i = i2;
                        } else if (Util.equal(Hpack.STATIC_HEADER_TABLE[i2].value, jMVar)) {
                            i = i2;
                            i2++;
                        }
                    }
                ...
                if (i2 == -1) {
                    ...
                    while (true) {
                        ...
                        if (Util.equal(this.dynamicTable[i5].name, r4)) {
                            if (Util.equal(this.dynamicTable[i5].value, jMVar)) {
                ...
                if (i2 != -1) {
                    ...
                    this.out.m2899(64);
                    writeByteString(r4);
                    writeByteString(jMVar);
                    insertIntoDynamicTable(header);
                } else {
                    jM jMVar2 = Header.PSEUDO_PREFIX;
                    if (!r4.m2963(0, jMVar2, 0, jMVar2.m2967()) || Header.TARGET_AUTHORITY.equals(r4)) {
                        writeInt(i, 63, 64);
                        writeByteString(jMVar);
                        insertIntoDynamicTable(header);
                    } else {
        ...
        public final void writeInt(int i, int i2, int i3) {
            ...
            this.out.m2899(i3 | i2);
            int i4 = i - i2;
            while (i4 >= 128) {
                this.out.m2899(128 | (i4 & Hpack.PREFIX_7_BITS));
                i4 >>>= 7;
            }
            this.out.m2899(i4);
        }
        ...
        /* access modifiers changed from: package-private */
        public final void writeByteString(jM jMVar) {
            if (!this.useCompression || Huffman.get().encodedLength(jMVar) >= jMVar.m2967()) {
                writeInt(jMVar.m2967(), Hpack.PREFIX_7_BITS, 0);
                jMVar.m2958(this.out);
                return;
            }
            jH jHVar = new jH();
            Huffman.get().encode(jMVar, jHVar);
            jM jMVar2 = new jM(jHVar.m2893());
            writeInt(jMVar2.m2967(), Hpack.PREFIX_7_BITS, 128);
            jMVar2.m2958(this.out);
        }
    ...
    static jM checkLowercase(jM jMVar) {
        int r0 = jMVar.m2967();
        int i = 0;
        while (i < r0) {
            byte r2 = jMVar.m2956(i);
            if (r2 < 65 || r2 > 90) {
                i++;
            } else {
