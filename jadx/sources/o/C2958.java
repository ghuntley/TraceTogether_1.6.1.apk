...
public class C2958 extends ViewGroup {
    ...
    public C2958(Context context) {
        this(context, (AttributeSet) null);
    }

    public C2958(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public C2958(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.mBaselineAligned = true;
        this.mBaselineAlignedChildIndex = -1;
        this.mBaselineChildTop = 0;
        this.mGravity = 8388659;
        C1992 r4 = new C1992(context, context.obtainStyledAttributes(attributeSet, C2745.aux.f12859, i, 0));
        int i2 = C2745.aux.f12862;
        int i3 = r4.f9934.getInt(1, -1);
        if (i3 >= 0) {
            setOrientation(i3);
        }
        int i4 = C2745.aux.f12835;
        int i5 = r4.f9934.getInt(0, -1);
        if (i5 >= 0) {
            setGravity(i5);
        }
        int i6 = C2745.aux.f12922;
        boolean z = r4.f9934.getBoolean(2, true);
        if (!z) {
            setBaselineAligned(z);
        }
        int i7 = C2745.aux.f12933;
        this.mWeightSum = r4.f9934.getFloat(4, -1.0f);
        int i8 = C2745.aux.f12913;
        this.mBaselineAlignedChildIndex = r4.f9934.getInt(3, -1);
        int i9 = C2745.aux.f12962;
        this.mUseLargestChild = r4.f9934.getBoolean(7, false);
        setDividerDrawable(r4.m10793(C2745.aux.f12930));
        int i10 = C2745.aux.f12953;
        this.mShowDividers = r4.f9934.getInt(8, 0);
        int i11 = C2745.aux.f12914;
        this.mDividerPadding = r4.f9934.getDimensionPixelSize(6, 0);
        r4.f9934.recycle();
    }
    ...
    public void drawDividersVertical(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < virtualChildCount; i2++) {
            ...
            if (!(virtualChildAt == null || virtualChildAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i2))) {
                drawHorizontalDivider(canvas, (virtualChildAt.getTop() - ((C2959) virtualChildAt.getLayoutParams()).topMargin) - this.mDividerHeight);
            }
        }
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            ...
            if (virtualChildAt2 == null) {
                ...
                i = virtualChildAt2.getBottom() + ((C2959) virtualChildAt2.getLayoutParams()).bottomMargin;
            }
    ...
    public void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i5 = 0; i5 < virtualChildCount; i5++) {
            ...
            if (!(virtualChildAt == null || virtualChildAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i5))) {
                C2959 r4 = (C2959) virtualChildAt.getLayoutParams();
                if (r1) {
                    i4 = virtualChildAt.getRight() + r4.rightMargin;
                } else {
                    i4 = (virtualChildAt.getLeft() - r4.leftMargin) - this.mDividerWidth;
                }
        ...
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            View virtualChildAt2 = getVirtualChildAt(virtualChildCount - 1);
            if (virtualChildAt2 != null) {
                C2959 r2 = (C2959) virtualChildAt2.getLayoutParams();
                if (r1) {
                    i3 = virtualChildAt2.getLeft() - r2.leftMargin;
                    i2 = this.mDividerWidth;
                } else {
                    i = virtualChildAt2.getRight() + r2.rightMargin;
    ...
    public int getBaseline() {
        ...
        if (childCount > i2) {
            ...
            if (baseline != -1) {
                ...
                return i3 + ((C2959) childAt.getLayoutParams()).topMargin + baseline;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:143:0x033f  */
    /* JADX WARNING: Removed duplicated region for block: B:144:0x0341  */
    ...
    public void measureVertical(int r34, int r35) {
        ...
        L_0x02a1:
            ...
            o.ԇ$ǃ r14 = (o.C2958.C2959) r14
            float r10 = r14.f13690
        ...
        L_0x03a4:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: o.C2958.measureVertical(int, int):void");
    }
    ...
    private void forceUniformWidth(int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (virtualChildAt.getVisibility() != 8) {
                C2959 r8 = (C2959) virtualChildAt.getLayoutParams();
                if (r8.width == -1) {
                    int i4 = r8.height;
                    r8.height = virtualChildAt.getMeasuredHeight();
    ...
    /* JADX WARNING: Removed duplicated region for block: B:186:0x047e  */
    ...
    public void measureHorizontal(int r38, int r39) {
        ...
        L_0x051e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: o.C2958.measureHorizontal(int, int):void");
    }
    ...
    private void forceUniformHeight(int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (virtualChildAt.getVisibility() != 8) {
                ...
                if (r8.height == -1) {
                    int i4 = r8.width;
                    r8.width = virtualChildAt.getMeasuredWidth();
    ...
    public void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        while (i13 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                C2959 r5 = (C2959) virtualChildAt.getLayoutParams();
                int i14 = r5.f13691;
                if (i14 < 0) {
                    i14 = i12;
                }
                int r1 = C2409.m12455(i14, C0293.m4156(this)) & 7;
                if (r1 == 1) {
                    i7 = ((paddingRight2 - measuredWidth) / 2) + paddingLeft + r5.leftMargin;
                    i6 = r5.rightMargin;
                    i8 = i7 - i6;
                } else if (r1 != 5) {
                    i8 = r5.leftMargin + paddingLeft;
                } else {
                ...
                i5 = i16 + measuredHeight + r5.bottomMargin + getNextLocationOffset(virtualChildAt);
            }
            i13++;
        }
    }
    ...
    public void layoutHorizontal(int r25, int r26, int r27, int r28) {
        /*
            ...
            int r1 = o.C0293.m4156(r24)
            int r1 = o.C2409.m12455(r2, r1)
            r15 = 2
            r5 = 1
        ...
        L_0x0140:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: o.C2958.layoutHorizontal(int, int, int, int):void");
    }
    ...
    public C2959 generateLayoutParams(AttributeSet attributeSet) {
        return new C2959(getContext(), attributeSet);
    }

    /* access modifiers changed from: protected */
    public C2959 generateDefaultLayoutParams() {
        int i = this.mOrientation;
        if (i == 0) {
            return new C2959(-2, -2);
        }
        if (i == 1) {
            return new C2959(-1, -2);
        }
        return null;
    }

    /* access modifiers changed from: protected */
    public C2959 generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return new C2959(layoutParams);
    }

    /* access modifiers changed from: protected */
    public boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return layoutParams instanceof C2959;
    }
    ...
    /* renamed from: o.ԇ$ǃ  reason: contains not printable characters */
    public static class C2959 extends ViewGroup.MarginLayoutParams {
        ...
        public C2959(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            this.f13691 = -1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2745.aux.f12941);
            this.f13690 = obtainStyledAttributes.getFloat(C2745.aux.f12952, 0.0f);
            this.f13691 = obtainStyledAttributes.getInt(C2745.aux.f12944, -1);
            obtainStyledAttributes.recycle();
        }

        public C2959(int i, int i2) {
            super(i, i2);
            this.f13691 = -1;
            this.f13690 = 0.0f;
        }

        public C2959(ViewGroup.LayoutParams layoutParams) {
            super(layoutParams);
            this.f13691 = -1;
        }
    }
