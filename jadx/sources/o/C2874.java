...
public class C2874 extends ViewGroup {

    /* renamed from: ı  reason: contains not printable characters */
    private int f13402 = -1;

    public C2874(Context context) {
        super(context, (AttributeSet) null, 0);
    }

    public C2874(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
    }

    public C2874(Context context, AttributeSet attributeSet, int i) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int baseline = (this.f13402 == -1 || childAt.getBaseline() == -1) ? paddingTop : (this.f13402 + paddingTop) - childAt.getBaseline();
