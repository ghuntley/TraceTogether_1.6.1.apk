...
class ReducerUiState extends np<StateUi> {
    ReducerUiState() {
    }
    ...
    public zendesk.support.request.StateUi reduce(zendesk.support.request.StateUi r5, o.nc<?> r6) {
        /*
            r4 = this;
        ...
        L_0x0034:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: zendesk.support.request.ReducerUiState.reduce(zendesk.support.request.StateUi, o.nc):zendesk.support.request.StateUi");
    }
